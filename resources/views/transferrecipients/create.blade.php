...
<div class="row pl-4 page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-primary">Create Transfer Recipient</h3>
        </div>
                            ...
                            <div class="row" justify-content-center align-items-center align-middle>
                                ...
                                <div class="" >
                                    <div class="tab-content ">
                                        <div class="" id="trip_details">
                                            ...
                                            <div class="row m-0">
                                                <div class="col-md-6">
                                                    {!!Form::text('account_name', 'Account Name')->readonly()!!}
                                ...
                                <div class="form-row  m-0 p-5 text-center">
                                    <div class="col-12">
                                        ...
                                        <a href="{{ route('transferrecipient.index') }}" class="btn btn-primary">Cancel</a>
                                    </div>
                                </div>
                                {!!Form::close()!!}
                            </div>
